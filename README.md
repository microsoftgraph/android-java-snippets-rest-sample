...
7. Find the [```CLIENT_ID```](app/src/main/java/com/microsoft/o365_android_unified_api_snippets/ServiceConstants.java#L10) string and set its value to the client id you registered in Azure.
8. Find the [```REDIRECT_URI```](app/src/main/java/com/microsoft/o365_android_unified_api_snippets/ServiceConstants.java#L9) string and set its value to the redirect URI you registered in Azure.
