...
public class ServiceConstants {
    ...
    public static final String[] SCOPES = {"openid", "Directory.Read.All","Calendars.ReadWrite","Files.ReadWrite","Mail.ReadWrite","Mail.Send","User.ReadBasic.All", "Group.Read.All", "profile"};
}